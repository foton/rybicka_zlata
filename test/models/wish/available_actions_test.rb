...
class WishAvailableActionsTest < ActiveSupport::TestCase
  ...
  def test_action_from_donor_side
    ...
    assert_equal [:book, :call_for_co_donors], @wish.available_state_actions_for(@donor)
    
    @wish.book!(@donor)
    assert_equal [:show, :unbook, :gifted], @wish.available_actions_for(@donor)
    assert_equal [:unbook, :gifted], @wish.available_state_actions_for(@donor)
  ...
  def test_action_from_donor_side_with_co_donors
    ...
    assert_equal [:withdraw_call, :book], @wish.available_state_actions_for(@donor)
  ...
  def test_action_from_another_donor
    ...
    assert_equal [:book,:call_for_co_donors], @wish.available_state_actions_for(another_donor)
