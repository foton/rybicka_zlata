...
class ActionsHelperTest < ActionView::TestCase
 ...
 def test_link_to_wish_for_author
    ...
    tab << [:delete, "<span><a id=\"wishes_delete_#{@wish.id}\" class=\"delete\" data-confirm=\"Opravdu chcete přání &#39;My first wish&#39; smazat?\" data-confirm-yes=\"Ano\" data-confirm-no=\"Ne\" rel=\"nofollow\" data-method=\"delete\" href=\"#{path_to_wish_action_for_user(:delete, @author, @wish)}\">Smazat</a></span>"]
  ...
  def test_link_to_wish_for_author_through_remote
    tab=[  [:show, "<span><a id=\"wishes_show_#{@wish.id}\" class=\"show\" data-method=\"get\" href=\"#{path_to_wish_action_for_user(:show, @author, @wish)}\">Zobrazit</a></span>"] ]
    tab << [:edit, "<span><a id=\"wishes_edit_#{@wish.id}\" class=\"edit\" data-method=\"get\" href=\"#{path_to_wish_action_for_user(:edit, @author, @wish)}\">Upravit</a></span>"]
    tab << [:delete, "<span><a id=\"wishes_delete_#{@wish.id}\" class=\"delete\" data-confirm=\"Opravdu chcete přání &#39;My first wish&#39; smazat?\" data-confirm-yes=\"Ano\" data-confirm-no=\"Ne\" data-remote=\"true\" rel=\"nofollow\" data-method=\"delete\" href=\"#{path_to_wish_action_for_user(:delete, @author, @wish)}\">Smazat</a></span>"]
  ...
  def test_link_to_wish_for_author_through_remote_with_additional_params
    ...
    tab << [:delete, "<span><a id=\"wishes_delete_#{@wish.id}\" class=\"delete\" data-confirm=\"Opravdu chcete přání &#39;My first wish&#39; smazat?\" data-confirm-yes=\"Ano\" data-confirm-no=\"Ne\" data-remote=\"true\" rel=\"nofollow\" data-method=\"delete\" href=\"#{path_to_wish_action_for_user(:delete, @author, @wish, {bb: 11})}\">Smazat</a></span>"]
  ...
  def test_link_to_wish_for_donee
    ...
    tab << [:delete, "<span><a id=\"wishes_delete_#{@wish.id}\" class=\"delete\" data-confirm=\"Opravdu chcete přání &#39;My first wish&#39; smazat?\" data-confirm-yes=\"Ano\" data-confirm-no=\"Ne\" rel=\"nofollow\" data-method=\"delete\" href=\"#{path_to_wish_action_for_user(:delete, @donee, @wish)}\">Smazat</a></span>"]
  ...
  def test_link_to_wish_for_donor
    for action in [:book, :call_for_co_donors]
  ...
  def test_button_to_wish_for_author
    ...
    tab << [:delete, "<span><a class=\"delete #{mdl_classes}\" id=\"wishes_delete_#{@wish.id}\" data-confirm=\"Opravdu chcete přání &#39;My first wish&#39; smazat?\" data-confirm-yes=\"Ano\" data-confirm-no=\"Ne\" rel=\"nofollow\" data-method=\"delete\" href=\"#{path_to_wish_action_for_user(:delete, @author, @wish)}\">Smazat</a></span>"]
  ...
  def test_button_to_wish_for_author_through_remote
    tab=[  [:show, "<span><a class=\"show #{mdl_classes}\" id=\"wishes_show_#{@wish.id}\" data-method=\"get\" href=\"#{path_to_wish_action_for_user(:show, @author, @wish)}\">Zobrazit</a></span>"] ]
    tab << [:edit, "<span><a class=\"edit #{mdl_classes}\" id=\"wishes_edit_#{@wish.id}\" data-method=\"get\" href=\"#{path_to_wish_action_for_user(:edit, @author, @wish)}\">Upravit</a></span>"]
    tab << [:delete, "<span><a class=\"delete #{mdl_classes}\" id=\"wishes_delete_#{@wish.id}\" data-confirm=\"Opravdu chcete přání &#39;My first wish&#39; smazat?\" data-confirm-yes=\"Ano\" data-confirm-no=\"Ne\" data-remote=\"true\" rel=\"nofollow\" data-method=\"delete\" href=\"#{path_to_wish_action_for_user(:delete, @author, @wish)}\">Smazat</a></span>"]
  ...
  def test_button_to_wish_for_author_through_remote_with_additional_params
    ...
    tab << [:delete, "<span><a class=\"delete #{mdl_classes}\" id=\"wishes_delete_#{@wish.id}\" data-confirm=\"Opravdu chcete přání &#39;My first wish&#39; smazat?\" data-confirm-yes=\"Ano\" data-confirm-no=\"Ne\" data-remote=\"true\" rel=\"nofollow\" data-method=\"delete\" href=\"#{path_to_wish_action_for_user(:delete, @author, @wish, {bb: 11})}\">Smazat</a></span>"]
    # '&' joinning params is converted to &amp; in link_to helper
  ...
  def test_button_to_wish_for_donee
    ...
    tab << [:delete, "<span><a class=\"delete #{mdl_classes}\" id=\"wishes_delete_#{@wish.id}\" data-confirm=\"Opravdu chcete přání &#39;My first wish&#39; smazat?\" data-confirm-yes=\"Ano\" data-confirm-no=\"Ne\" rel=\"nofollow\" data-method=\"delete\" href=\"#{path_to_wish_action_for_user(:delete, @donee, @wish)}\">Smazat</a></span>"]
