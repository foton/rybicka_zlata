...
class AddDoneeDonorLinks < ActiveRecord::Migration
  def change
    ...
    add_index :donee_links, %i[wish_id connection_id], name: 'donee_wish_conn_index', unique: true
    ...
    add_index :donor_links, %i[wish_id connection_id], name: 'donor_wish_conn_index', unique: true
  end
end
