...
/* modified according to PR  https://github.com/Marco129/mdl-jquery-modal-dialog/commit/227b951c7eb858cead3089be0d17715b26fcec8e */
    ...
    if (options.negative || options.positive) {
        ...
        if (options.negative) {
            ...
            negButton.click(function (e) {
                e.preventDefault();
                 if (!options.negative.onClick)
                   hideDialog(dialog);
                 else
                   options.negative.onClick(e);
            });
...
// from https://raw.githubusercontent.com/MEYVN-digital/mdl-selectfield/master/mdl-selectfield.min.js
(function () {
  'use strict';
